...
_G.Settings = {
	...
	Fruits = {
		...
		["Select Devil Fruits"] = {"Dough-Dough"}, -- {"Bomb-Bomb","Spike-Spike","Chop-Chop","Spring-Spring","Kilo-Kilo","Spin-Spin","Kilo-Kilo","Spin-Spin","Bird: Falcon","Smoke-Smoke","Flame-Flame","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Love-Love","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Door-Door","Quake-Quake","Human-Human: Buddha","String-String","Bird-Bird: Phoenix","Rumble-Rumble","Paw-Paw","Gravity-Gravity","Dough-Dough","Shadow-Shadow","Venom-Venom","Control-Control","Soul-Soul","Dragon-Dragon"}
	...
	Raids = {
		...
		["Select Raids"] = {"Flame","Dough"}, -- {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix","Dough"},
	},
...
local Properties = {
	RoundFrame = {
		...
		Image = "http://www.roblox.com/asset/?id=16485192297",
...
LoadButton.Size = UDim2.new(0, 70, 0, 70)
		LoadButton.Image = "http://www.roblox.com/asset/?id=16485192297"
...
LoadScrollbar.Image = "http://www.roblox.com/asset/?id=16485192297"
	...
	LoadButton.MouseButton1Down:Connect(function()
		if LoadFocus == false then
			...
			repeat wait()
				...
				TitleLoad.Text = "Get Wildcard Script Version : 1.0.0"
				wait(0.35)
				TweenService:Create(
					TitleLoad,
					TweenInfo.new(.5, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
				...
				TitleLoad.Text = "Welcome to Wildcard Script | Edition"
...
function Library.new()
	...
	function LibraryTab.tab(options)
		...
		Icon.Image = "http://www.roblox.com/asset/?id=16485192297"..tostring(Logo)
		...
		function LibraryPage.page()
			...
			function LibraryFunction.Toggle(options)
				...
				LockIcon.Image = "http://www.roblox.com/asset/?id=16485192297"
			...
			function LibraryFunction.MultiDropdown(options)
				...
				Arrow.Image = "http://www.roblox.com/asset/?id=16485192297"
				...
				for i,v in pairs(Item) do
					...
					Logo.Image = "http://www.roblox.com/asset/?id=16485192297"
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Wildcard Hub Scripts") then
			makefolder("Wildcard Hub Scripts")
		end
		if not isfolder("Wildcard Hub Scripts/Blox Fruits/") then
			makefolder("Wildcard Hub Scripts/Blox Fruits/")
		end
		if not isfile("Wildcard Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Wildcard Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Wildcard Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Wildcard Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Wildcard Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
function AutoFarmLevel()
	...
	if _G.Settings.Main["Cuttay/KaitunFarm Level"] and (MyLevel >= 15 and MyLevel <= 300) then
